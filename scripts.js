...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (venueInput) {
        venueInput.addEventListener('input', function() {
            const vA = { "Mood Live": "Ministro Gonzalez 40", "RucaChe": "Antártida Argentina 3901", "Espacio Duam": "San Martin 5901", "Autódromo Parque Ciudad de Centenario": "Ruta Provincial 7, a la altura del km 1337" };
